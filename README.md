...
| 이주은 <br/> (Jueun Lee)          |- Deploy spring server with GCP Virtual Machine<br/>- Manage MySql DB with GCP SQL<br/>- [Server APIs](http://34.64.191.49:8080/swagger-ui/index.html)|
